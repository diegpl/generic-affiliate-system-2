...
Insert this peace of line at single.php at the place do you want to show the products:  php mlv_contextual('produtos')

And this at the place that you want to show the banner: php mlv_contextual('banner'). 

If you want to show at widgets we indicate the exec_php plugin (http://wordpress.org/plugins/exec-php/)
...
7. Insert this code at the place that do you want to show products: php mlv_contextual('produtos')
8. Insert this code at the place that do you want to show the banner: php mlv_contextual('banner')
9. It is all, now distribute this plugin for your partners with yours products!!!  
